...
{     delay(15000);
      ...
      // -- COMPRESSÃO--
       for(int qtd_msn=1;qtd_msn<20;qtd_msn++){// Laço que determina a quantidade de mensagem por compressão, indo de 1 a grupos de 39.
...
//       free(mensagem_descompress);
     ...
     // Serial.println("PROBLEMA AQUI 2");
      delete_list(dic_list);
    //  Serial.println("PROBLEMA AQUI 3");
            }
       delay(1000);
      }
      }
