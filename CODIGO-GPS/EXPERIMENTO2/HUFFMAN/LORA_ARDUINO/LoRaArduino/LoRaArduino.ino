...
{     delay(15000);
      ...
      Serial.println("");
      // -- COMPRESSÃO--
      for(int qtd_msn=90;qtd_msn<100;qtd_msn++){// Laço que determina a quantidade de mensagem por compressão, indo de 1 a grupos de 20.
      Serial.printf("qtd msn %d \n",qtd_msn);
       for(int grop=0;grop<5;grop++){ // LAÇO QUE DETERMINA QUANTAS VEZES SERÁ REALIZADA AQUELE GRUPO DE COMPRESSÕES
        for(int i=0;i<2;i++){ // NÚMERO DE COMPRESSÕES CONSECUTIVAS 
