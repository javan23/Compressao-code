...
//      int pacote=7; 
      int tempo=60000;// INTERVALO ENTRE AS MENSAGEM

  
      delay(15000); // DELAY INICIAL // MENSAGEM A SER COMPRIMIDA
      unsigned char *mensagem; // MENSAGEM  COMPRIMIDA
      int tam=0; // TAMANHO COMPRIMIDO
      for (int i=0;i<pacote;i++){
       ...
       Serial.printf("ENTREI AQUI %d ",tam);
