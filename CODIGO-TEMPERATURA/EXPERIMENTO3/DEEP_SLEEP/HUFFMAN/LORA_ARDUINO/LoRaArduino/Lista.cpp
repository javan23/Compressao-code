...
for(int i=0;i<TAB_OFFSET-1;i++){
    ...
    if(t[i]){
            if(i<10){
                ...
                insere_elemento_lista_ordenado(lista_ord,cria_no(t[i],47,NULL,NULL,NULL));
                    ...
                    insere_elemento_lista_ordenado(lista_ord,cria_no(t[i],60,NULL,NULL,NULL));

                }
                else if(i==12){
                  
                    insere_elemento_lista_ordenado(lista_ord,cria_no(t[i],62,NULL,NULL,NULL));

                }
                else if(i==13){
                  
                    insere_elemento_lista_ordenado(lista_ord,cria_no(t[i],38,NULL,NULL,NULL));
