...
{     delay(5000);
      ...
      for(int qtd_msn=1;qtd_msn<40;qtd_msn++){    // Laço que determina a quantidade de mensagem por compressão, indo de 1 a grupos de 39.
        ...
        constroi_lista(dic_list); // Inicialização da lista.
       ...
       unsigned long  stop =micros() - start; // Inicia a aferição do tempo
       ...
       compress_vlr = DESCOMPRIME_LZ78(mensagem,mensagem_descompress,tamanho_comprimido);
